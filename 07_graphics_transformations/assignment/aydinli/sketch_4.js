...
function draw() {
  ...
  //Grid is generated byi iterating through y and x.
  //For each 50px along x and y axis a square is geenrated depending on the position on the mouse
  for (let i = 50; i < mouseX; i += 50) {
    for (let j = 50; j < mouseY; j += 50) {
      noFill()

       //stroke color is set by mousePosition and the index of the for loop
