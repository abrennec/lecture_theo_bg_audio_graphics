...
void main() {
  ...
  float distortion2 = pnoise(uScaleValue*aPosition*uFrameCount, vec3(-1));
  positionVec4.y += distortion2 * aNormal.x* amplitude*2.0;
  positionVec4.x += distortion * aNormal.y * amplitude*0.7;
