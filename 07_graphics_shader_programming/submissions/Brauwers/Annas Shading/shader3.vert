...
vec2 mouse = u_mouse.xy / u_resolution;
  ...
  //float distortionX = cnoise(positionVec4 * frequency + uFrameCount * 0.1);
  float distortionX = cnoise(positionVec4 * frequency + uFrameCount * 0.01);
  //float distortionY = cnoise(positionVec4.y * frequency + uFrameCount * 0.01);

  positionVec4.x += distortionX * aNormal.x * amplitude ;
  positionVec4.y += distortionX * aNormal.y * amplitude;
  positionVec4.z += distortionX* aNormal.z * amplitude;
