...
// Created with help by / copying and adapting code of Marco Winter!
...
//uniform float uframesSinceClick;
...
void main() {
  ...
  //float distortion = sin(positionVec4.x * uFrequency + uFrameCount * 0.1);
  
  float distortion2 = pnoise(1.0 * aPosition + uFrameCount * 0.1, 1.0 * aPosition + uFrameCount * 0.1);
  float distortion3 = cnoise(1.0 * aPosition + uFrameCount * 0.1);

  //float distortion2 = pnoise(1.0 * aPosition + uframesSinceClick * 0.1, 1.0 * aPosition + uframesSinceClick * 2.0);
  //float distortion3 = cnoise(1.0 * aPosition + uframesSinceClick * 0.1);

  positionVec4.x += distortion2 * aNormal.x * uAmplitudeY;
  positionVec4.y += distortion3 * aNormal.y * uAmplitudeX;
  positionVec4.z += distortion2 * aNormal.z * uAmplitudeY;
