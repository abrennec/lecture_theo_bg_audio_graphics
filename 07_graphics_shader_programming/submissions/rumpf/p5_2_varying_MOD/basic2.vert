...
////////////
    //QUESTION: As I understand it, gl_Position is the screenspace position? What exactly are the z (depth? so in normalized clipping space?), and w values referring to? And why is (0,0) in the bottom left corner?
////////////
