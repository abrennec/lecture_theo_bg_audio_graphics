...
void draw() {
  ...
  // task 8
  //camera(mouseX, mouseY, 120, 
  //width/2, height/2, 0,
  //0.0, 1.0, 0.0);
  
  // task 9
  a += 0.01;
  camera(sin(a)* width, 0, 120, 
  width/2, height/2, 0,
   0.0, 1.0, 0.0);
  
  // task 7
  spotLight(255, 255, 255, width/2, height/2, 200, 0, 0, -1, PI/2, 2);
