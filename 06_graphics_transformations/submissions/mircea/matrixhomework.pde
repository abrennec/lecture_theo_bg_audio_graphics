...
//TASK 1:  Checkout the code and understand how the ellipse is moved around using the two vector variables. Comment!
           // Response: ellipseDirection is added to ellipseLocation each frame and determinates speed and direction. When it hits a x/y wall, the specific x/y value is inverted. 
